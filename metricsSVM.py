...
import numpy as np
import joblib  # To load the SVM model
...
# Model architecture (assuming the same as previously defined)
...
# Evaluation function using SVM
def evaluate_svm(svm_classifier, model, loader):
    model.eval()
    y_true = []
    y_pred = []
    val_losses = []
...
metrics = evaluate_svm(svm_classifier, model, valid_loader)
...
# Assuming class names are known and in the correct order
