...
model = ResNet9(3, 38)
model.load_state_dict(torch.load('plant_disease_model_KNN.pth'))
...
def evaluate_knn(knn_classifier, model, loader):
    model.eval()
...
metrics = evaluate_knn(knn_classifier, model, valid_loader)
